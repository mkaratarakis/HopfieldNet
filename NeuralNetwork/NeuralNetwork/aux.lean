...
variable {U : Type*} {R : Type*} {m : ℕ} [Field R] --[LinearOrder R] [IsStrictOrderedRing R]
...
lemma sum_split {α β : Type*} (s : Finset α) (P Q : α → Prop) [DecidablePred P] [AddCommMonoid β]
...
lemma sum_over_subset {α β : Type*} (f : α → β) (s : Finset α) [Fintype α] [AddCommMonoid β]
